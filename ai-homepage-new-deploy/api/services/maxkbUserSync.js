...
import { upsertUser, getUsers, saveUsers } from './user.js';
...
export const syncMaxKBUsers = async () => {
    ...
    try {
        ...
        const maxkbUsernames = new Set(records.map((r) => r.username || r.name || r.email).filter(Boolean));
        let syncedCount = 0;
...
//# sourceMappingURL=maxkbUserSync.js.map