...
const organicBentoTheme: ThemeConfig = {
  ...
  fonts: {
    ...
    googleFontsUrl: 'https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Roboto:wght@400;500;700&display=swap',
  },
  colors: {
    background: '#F7F5EE',
...
const luxuryDarkTheme: ThemeConfig = {
  ...
  fonts: {
    primary: '"Inter", sans-serif',
    secondary: '"Roboto", sans-serif',
    googleFontsUrl: 'https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600&family=Roboto:wght@300;400;500;700&display=swap',
  },
  colors: {
    background: '#121212',
...
const pastelDreamTheme: ThemeConfig = {
  ...
  colors: {
    ...
    primaryLight: '#F3E8FF',
    primaryDark: '#7E22CE',
    accent1: '#E9D5FF', // Lavender
    accent2: '#BAE6FD', // Sky
    accent3: '#CCFBF1', // Mint
    accent4: '#FECDD3', // Peach
    textMain: '#475569', // slate-soft
